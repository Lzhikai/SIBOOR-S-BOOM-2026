...
#define CUSTOM_MACHINE_NAME "S_BOOM"
...
#define PIDTEMPBED
  ...
  #define DEFAULT_BED_KP 78.5
  #define DEFAULT_BED_KI 13.10
  #define DEFAULT_BED_KD 289.8
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 80, 691 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 10000, 4000, 10000, 10000}
...
//#define LCD_BED_LEVELING
  ...
  //#define MESH_EDIT_Z_STEP  0.025 // (mm) Step size while manually probing Z axis. 改动
  //#define LCD_PROBE_Z_RANGE 4     // (mm) Z Range centered on Z_MIN_POS for LCD Z adjustment 改动
