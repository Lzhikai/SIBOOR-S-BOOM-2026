...
#define HOMING_BUMP_MM      { 5, 3, 2 }       // (linear=mm, rotational=°) Backoff from endstops after first bump
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define BROWSE_MEDIA_ON_INSERT          // Open the file browser when media is inserted 改动
  ...
  //#define USB_FLASH_DRIVE_SUPPORT
    ...
    /**
     * Native USB Host supported by some boards (USB OTG) 改动
     */
